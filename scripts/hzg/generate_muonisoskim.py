...
if __name__=='__main__':
  ...
  cuts = ['tag_muon_preselection(Muon_pt, Muon_eta, Muon_phi, Muon_dxy, Muon_dz, Muon_sip3d, Muon_pfRelIso03_all, Muon_looseId, Muon_charge, TrigObj_pt, TrigObj_eta, TrigObj_phi, TrigObj_id, TrigObj_filterBits, '+tag_idx_string+')']
