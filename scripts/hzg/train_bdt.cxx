...
void train_bdt() {
  ...
  TMVA::Tools::Instance();
	...
	TFile* sig_input_file = TFile::Open("ntuples/shuffle_kinbdt_narrowmasscut_sig.root");
	TFile* bak_input_file = TFile::Open("ntuples/shuffle_kinbdt_narrowmasscut_bak.root");
	TFile* output_file = TFile::Open("ntuples/output_kinbdt_masscut_topeleven_850trees.root","RECREATE");

	TMVA::Factory *bdt_factory = new TMVA::Factory("kinbdt_masscut_topeleven_850trees",output_file,"!V:ROC:!Correlations:!Silent:Color:!DrawProgressBar:AnalysisType=Classification");
  ...
  bdt_loader.SetSignalWeightExpression("w_lumi");
	...
	TCut cut_s, cut_b;
	bdt_loader.PrepareTrainingAndTestTree(cut_s,cut_b,"nTrain_Signal=50000:nTrain_Background=50000:SplitMode=Block:NormMode=NumEvents:!V");
