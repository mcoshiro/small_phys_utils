...
if __name__=='__main__':
  ...
  defines = [#('photon_mva','photon_idmva[0]'),
             ...
             #('cosTheta','get_correct_cosTheta(photon_pt,photon_eta,photon_phi,el_pt,el_eta,el_phi,el_charge,mu_pt,mu_eta,mu_phi,mu_charge,ll_lepid,ll_i1,ll_i2)'),
             #('costheta','get_correct_costheta(photon_pt,photon_eta,photon_phi,el_pt,el_eta,el_phi,el_charge,mu_pt,mu_eta,mu_phi,mu_charge,ll_lepid,ll_i1,ll_i2)'),
             #('phi','get_correct_phi(photon_pt,photon_eta,photon_phi,el_pt,el_eta,el_phi,el_charge,mu_pt,mu_eta,mu_phi,mu_charge,ll_lepid,ll_i1,ll_i2)'),
             ...
             #('ph_hoe','photon_hoe[0]')]
  #branches = ('pt_llg','eta_llg','phi_llg','cosTheta','Phi','costheta','phi',
  #    'mll','mllg','w_lumi_year')
  branches = ('mllg','w_lumi_year')
  #defines = [('photon_mva','photon_idmva[0]'),
  #           ('pt_mass','llphoton_pt[0]/llphoton_m[0]'),
  #           ('min_dR','photon_drmin[0]'),
  ...
  lumis = ['36.3','41.5','59.7']
  #lumis = ['89.4','102.2','147.1'] #scaled to run 3
  base_name = 'dnnweights'
