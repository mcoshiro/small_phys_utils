...
if __name__=='__main__':
  ...
  #currently, hard-code scaler parameters, but later make it so these can also be loaded from a file
  #scaler_mean = [128.25409238333538]
  #scaler_vari = [262.11346016769227]
  scaler_mean = [-0.03256837723257575,0.13551318626549677,-0.14350527295461693,0.04035440965565152,0.11195548904182595,0.4076912669285274,0.1801786392764193,0.20524731889408906,-0.019321336455538195]
  scaler_vari = [7254.086377812586,7262.075609483,45313.38686489131,7273.529710735457,7290.03911397307,45258.768234357005,4005.8281428198134,3981.094011758424,16155.035620288209]
  ...
  output_code += '\n'
  output_code += 'enum class ActivationType{relu, sigmoid};\n'
  output_code += '\n'
  ...
  output_code += '  float dot_product(std::vector<float> x, std::vector<float> y);\n'
  output_code += '  float relu(float x);\n'
  output_code += '  float sigmoid(float x);\n'
  output_code += '\n'
  output_code += '  unsigned n_layer;\n'
  output_code += '  unsigned n_input;\n'
  output_code += '  std::vector<unsigned> n_unit;\n'
  output_code += '  std::vector<ActivationType> activation_type;\n'
  ...
  output_code += '\n'
  output_code += 'float '+class_name+'::evaluate(std::vector<float> input) {\n'
  ...
  output_code += '      if (activation_type[ilayer]==ActivationType::relu)\n'
  output_code += '        layer_output[iunit] = relu(unit_input);\n'
  output_code += '      else if (activation_type[ilayer]==ActivationType::sigmoid)\n'
  ...
  output_code += '}\n'
  output_code += '\n'
  output_code += 'float '+class_name+'::relu(float x) {\n'
  output_code += '  if (x < 0) return 0;\n'
  output_code += '  return x;\n'
  output_code += '}\n'
  output_code += '\n'
  output_code += 'float '+class_name+'::sigmoid(float x) {\n'
  output_code += '  return 1.0/(1.0+exp(-1.0*x));\n'
  output_code += '}\n'
  output_code += '\n'
  output_code += 'float '+class_name+'::dot_product(std::vector<float> x, std::vector<float> y) {\n'
  ...
  output_code += '}\n'
  output_code += '\n'
  output_code += 'std::vector<float> '+class_name+'::scale(std::vector<float> input) {\n'
