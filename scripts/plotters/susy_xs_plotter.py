...
mycanvas.SetLogx()
mycanvas.SetLogy()
base_histo = ROOT.TH1D('base_histo','SUSY production cross section vs. supersymmetric partner mass, #sqrt{s}=13 TeV; Supersymmetric partner mass [GeV]; Cross section [fb]',100,hist_left_edge,hist_right_edge)
...
base_histo.SetMinimum(1.0e-3) #1 1b
base_histo.SetMaximum(1.0e6) #1 nb
base_histo.Draw()
...
graphs_to_draw = [LineGraph([500,600,700,800,900,1000,1250,1500,1750,2000,2250,2500,2750,3000],[33800,11300,4320,1810,812,385,71.5,15.7,3.85,1.01,0.275,0.0768,0.0216,0.00612],'#color[800]{#tilde{g}#tilde{g}}').set_color(ROOT.kOrange),
